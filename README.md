...
Note: Replace '<your_api_key>' with your actual [OpenWeatherMap API key](https://openweathermap.org/api) and '<city>' with the city for which you want to retrieve weather data.
